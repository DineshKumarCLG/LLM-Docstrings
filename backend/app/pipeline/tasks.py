...
def run_bce(self, analysis_id: str, source_code: str) -> dict[str, Any]:
    ...
    try:
        ...
        extractor = BehavioralClaimExtractor()
...
def run_dts(
    ...
    try:
        ...
        synthesizer = DynamicTestSynthesizer(llm_provider=provider)
...
def run_pipeline(
    ...
    try:
        ...
        bce_result = run_bce(analysis_id, source_code)
        ...
        dts_result = run_dts(analysis_id, claim_schemas, llm_provider)
        ...
        rv_result = run_rv(analysis_id, test_suites, source_code)
